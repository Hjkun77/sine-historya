...
const TuPugCard = document.getElementById('tupug-card')
...
const TuPugCard1 = document.getElementById('tupug-card1')
const WalangDiyosCard1 = document.querySelector('#walangDiyos-card1')

var SortValue = document.getElementById('sortSelect').value
var MTRCBValue = document.getElementById('mtrcbSelect').value
...
function sortFunction() {
  ...
  if (SortValue === "1") {
    ...
    if (StreamingValue === "1") {
      ...
      SakayCard1.style.display = 'none'
      SisterCard1.style.display = 'none'
      TuPugCard1.style.display = 'block'
      WalangDiyosCard1.style.display = 'none'
      ...
      BatasCard1.style.display = 'block'
